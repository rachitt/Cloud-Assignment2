...
def is_db_connected():
    try:
        # Try a simple command to check if the database is reachable
...
@app.route("/healthz")
def health_check():
    return "Healthy", 200  # Simple check
...
if __name__ == "__main__":
    ...
    app.run(host='0.0.0.0', port=port, debug=debug)  # Changed here to listen on all addresses
